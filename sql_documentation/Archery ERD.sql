...
CREATE TABLE "club_eligibility" (
  "club_eligibility_code" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
COMMENT ON COLUMN "australia_archery_federation"."member_id" IS 'not set to increment because we need to manually specify admin_id to authorize existed or just-created accounts, the rule for an account to be admin is that the account_id == admin_id';
...
COMMENT ON COLUMN "yearly_club_championship"."club_eligibility_code" IS 'null if all clubs can participate';
...
3) club_eligibility_code in club_competition == club_eligibility_code in yearly club competition
';
...
COMMENT ON COLUMN "club_competition"."club_eligibility_code" IS 'null if all clubs can participate';
...
COMMENT ON COLUMN "request_competition_form"."round_id" IS 'nullable if registering to be a member of recorder since a recorder is responsible for the whole competition ';
...
percentile of c_(x) =  (   (index of c_(x) in d_sorted + 1) / m   ) * 100
...
ALTER TABLE "event_context" ADD FOREIGN KEY ("club_competition_id") REFERENCES "club_competition" ("club_competition_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "request_competition_form" ADD CONSTRAINT "want_to_participate" FOREIGN KEY ("sender_id") REFERENCES "archer" ("archer_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "request_competition_form" ADD CONSTRAINT "want_to_be_member_to_record" FOREIGN KEY ("sender_id") REFERENCES "recorder" ("recorder_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "request_competition_form" ADD FOREIGN KEY ("club_competition_id") REFERENCES "club_competition" ("club_competition_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "request_competition_form" ADD FOREIGN KEY ("round_id") REFERENCES "round" ("round_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "request_competition_form" ADD CONSTRAINT "recorder_who_is_the_creator_of_an_event" FOREIGN KEY ("reviewed_by") REFERENCES "recorder" ("recorder_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "category" ADD FOREIGN KEY ("equipment_id") REFERENCES "equipment" ("equipment_id");
...
ALTER TABLE "recording" ADD FOREIGN KEY ("club_competition_id") REFERENCES "club_competition" ("club_competition_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "recording" ADD FOREIGN KEY ("recording_id") REFERENCES "recorder" ("recorder_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "yearly_club_championship" ADD FOREIGN KEY ("creator_id") REFERENCES "recorder" ("recorder_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "club_competition" ADD FOREIGN KEY ("creator_id") REFERENCES "recorder" ("recorder_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "club_eligibility" ADD FOREIGN KEY ("eligible_club_id") REFERENCES "club" ("club_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "yearly_club_championship" ADD FOREIGN KEY ("club_eligibility_code") REFERENCES "club_eligibility" ("club_eligibility_code") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "club_competition" ADD FOREIGN KEY ("club_eligibility_code") REFERENCES "club_eligibility" ("club_eligibility_code") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "round_schedule" ADD FOREIGN KEY ("club_competition_id") REFERENCES "club_competition" ("club_competition_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "round_schedule" ADD FOREIGN KEY ("round_id") REFERENCES "round" ("round_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "category" ADD FOREIGN KEY ("age_division_id") REFERENCES "age_division" ("age_division_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "category" ADD FOREIGN KEY ("discipline_id") REFERENCES "discipline" ("discipline_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "round" ADD FOREIGN KEY ("category_id") REFERENCES "category" ("category_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "category_rating_percentile" ADD FOREIGN KEY ("archer_id") REFERENCES "archer" ("archer_id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "category_rating_percentile" ADD FOREIGN KEY ("category_id") REFERENCES "category" ("category_id") ON DELETE SET NULL ON UPDATE CASCADE;
