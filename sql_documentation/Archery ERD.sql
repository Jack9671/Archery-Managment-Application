...
COMMENT ON COLUMN "event_context"."event_context_id" IS 'generate id from sql code with format:competition_id-round_id-range_id-end_order, yearly_club_championship_id is not included since it can be null ';
